...
export const Footer = () => {
  ...
  const scrollToProducts = () => {
    productsRef.current.scrollIntoView({ behavior: "smoth" });
  };
      ...
      <div className="container footer__container">
        ...
        <div className="footer__info">
          ...
          <ul className="footer__developers">
            <li className="footer__developer">Designer: Anastasia Ilina</li>
            <li className="footer__developer">Developer: Maxnight</li>
          </ul>
        </div>
